...
function Search() {
    return (
        <div className='searchPage'>
            ...
            <ChannelRow  image='https://yt3.ggpht.com/ytc/AKedOLSsnWm_dQzIqM-qgW74yebXNX_b__k6WAeUBb6GeGQ=s176-c-k-c0x00ffffff-no-rj-mo' 
            channel='Google Developers' verified 
            videos={5,374}
            subs='2.18M' 
            desc='The Google Developers channel features talks from events, educational series, best practices, tips, and the latest updates across&nbsp;...' />

            <hr />
            <h2 className='latest'>Latest from Google Developers</h2>
